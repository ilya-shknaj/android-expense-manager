...
public class PinnedExpandableListAdapter extends BaseExpandableListAdapter implements IPinnedHeaderAdapter, OnScrollListener {
	 ...
	 */
	public void configurePinnedHeader(View convertView, int position) {
		getGroupView(position, true, convertView, null);
	}
