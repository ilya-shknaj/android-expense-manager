package by.gravity.expensemanager.util.math;
...
public class Parser {
	...
	static private final String[] procs1 = { "abs", "acos", "asin", "atan", "ceil", "cos", "exp", "floor", "log", "round", "sin", "sqrt", "tan" };
	static private final int[] rators1 = { Expr.ABS, Expr.ACOS, Expr.ASIN, Expr.ATAN, Expr.CEIL, Expr.COS, Expr.EXP, Expr.FLOOR, Expr.LOG,
