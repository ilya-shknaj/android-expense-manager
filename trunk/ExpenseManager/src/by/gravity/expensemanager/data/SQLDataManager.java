...
public class SQLDataManager {
	...
	public Cursor getPaymentsMethodsCursor() {
		return database.query(SQLConstants.TABLE_PAYMENT_METHODS, new String[] { SQLConstants.FIELD_NAME }, null, null, null, null, null);
	}
