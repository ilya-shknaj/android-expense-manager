...
public class ExpandingListView extends ListView {
	...
	private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			ExpandableModel viewObject = (ExpandableModel) getItemAtPosition(getPositionForView(view));
	...
	private int[] getTopAndBottomTranslations(int top, int bottom, int yDelta, boolean isExpanding) {
		...
		if (isExpanding) {
			...
			if (range < extent) {
				range = fakeScrollRange;
			}
			int leftoverExtent = range - offset - extent;
			// int leftoverExtent = extent - offset;
	...
	private void expandView(final View view) {
		final ExpandableModel viewObject = (ExpandableModel) getItemAtPosition(getPositionForView(view));
	...
	private void collapseView(final View view) {
		...
		view.setLayoutParams(new AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, viewObject.getCollapsedHeight()));
